...
public class BestSellerAdapter extends RecyclerView.Adapter<BestSellerAdapter.ViewHolder> {
    ...
    Tab1HomePageFragment context;
    ArrayList<BestSeller> bestSellers;
    public BestSellerAdapter(Tab1HomePageFragment context , ArrayList<BestSeller> arrayList) {
        this.context = context;
        this.bestSellers = arrayList;
    }

    public BestSellerAdapter(Tab1 tab1, ArrayList<BestSeller> arrayList) {
        this.context = context;
        this.bestSellers = arrayList;
    }
