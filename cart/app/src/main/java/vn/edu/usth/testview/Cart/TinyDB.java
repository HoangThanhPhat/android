...
public class TinyDB {
    ...
    public ArrayList<BestSeller> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<BestSeller> playerList =  new ArrayList<BestSeller>();

        for(String jObjString : objStrings){
            BestSeller player  = gson.fromJson(jObjString,  BestSeller.class);
    ...
    public void putListObject(String key, ArrayList<BestSeller> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(BestSeller player: playerList){
